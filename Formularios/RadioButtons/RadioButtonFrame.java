...
public class RadioButtonFrame extends JFrame 
{
    ...
    public RadioButtonFrame() 
    {
        ...
        plainJRadioButton = new JRadioButton("Simples", true); //já vem marcado
        boldJRadioButton = new JRadioButton("Negrito", false); //não vem marcado automaticamente.
